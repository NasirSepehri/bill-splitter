...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> missingServletRequestParameterException(Exception exception, WebRequest request) {
        log.info(exception.getMessage(), exception);
        String message = "";
        message = ((MissingServletRequestParameterException) exception).getMessage();
        return new ResponseEntity<>(createResponse(HttpStatus.BAD_REQUEST, message, request), HttpStatus.BAD_REQUEST);
    }
